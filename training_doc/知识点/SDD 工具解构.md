...
8. [延伸：让工具更健壮的进阶技巧](#延伸让工具更健壮的进阶技巧)
   - [技巧一：JSON Schema 校验工件完整性](#技巧一json-schema-校验工件完整性)
   - [技巧二：用 config.yaml 注入项目全局约束](#技巧二用-configyaml-注入项目全局约束)
   - [技巧三：delta spec 与主 spec 的同步提醒](#技巧三delta-spec-与主-spec-的同步提醒)
   - [技巧四：让工具可观测](#技巧四让工具可观测)
