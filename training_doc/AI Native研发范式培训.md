...
- **需求**：识别歧义、转换为可执行 Spec；关键 Harness：结构化业务规则，ROI 极高
...
### 第四部分：规格驱动开发 — 给 Agent 精确的任务边界和流程约束（约 1.5h）
...
### 第五部分：结构化业务规则 — 从增量 PRD 到唯一事实来源（约 0.5h）
