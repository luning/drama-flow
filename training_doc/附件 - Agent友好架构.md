...
后文 [4.3 经验层](#43-经验层复杂任务的知识注入与提炼) 中的 CLAUDE.md → INDEX.md → 具体经验文件结构，复用的是同一原则。
...
这与 [4.3 经验层](#43-经验层复杂任务的知识注入与提炼) 的经验库形成联动——经验层沉淀"做什么"的知识，约束层固化"怎么做"的流程，二者合力才能在高复杂度任务中持续保持 Agent 的输出质量。
